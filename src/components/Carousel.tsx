...
export default function Carousel({
  ...
  return (
    ...
    >
      ...
      {/* Flechas de navegación: visibles en desktop, aparecen con hover o siempre según contexto */}
      {modoImagen && items.length > 1 && (
        <>
          <button
            onClick={goPrev}
            className="hidden lg:flex absolute left-3 top-1/2 -translate-y-1/2 z-20 h-9 w-9 items-center justify-center rounded-full bg-black/50 text-white opacity-0 group-hover/carousel:opacity-100 transition-opacity duration-300 hover:bg-black/70"
          ...
          <button
            onClick={goNext}
            className="hidden lg:flex absolute right-3 top-1/2 -translate-y-1/2 z-20 h-9 w-9 items-center justify-center rounded-full bg-black/50 text-white opacity-0 group-hover/carousel:opacity-100 transition-opacity duration-300 hover:bg-black/70"
