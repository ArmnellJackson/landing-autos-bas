...
const VehicleCard = React.memo(function VehicleCard({
  ...
  return (
    <div
      className="group overflow-hidden border-none shadow-xl hover:shadow-2xl transition-all duration-500 bg-background dark:bg-[#050311] dark:shadow-[-5px_-5px_0px_#020107,5px_5px_0px_#08051b] rounded-[24px] h-full flex flex-col cursor-pointer"
      onClick={onOpen}
    >
...
function GalleryModal({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-[96%] h-[85vh] sm:w-[70%] sm:h-[80vh] lg:w-[55%] lg:h-[85vh] bg-background dark:bg-[#050311] dark:shadow-[-5px_-5px_0px_#020107,5px_5px_0px_#08051b] rounded-[24px] overflow-hidden shadow-2xl flex flex-col"
